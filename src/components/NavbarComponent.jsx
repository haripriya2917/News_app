...
const NavbarComponent = () => {
    ...
    const handleSearch = () => {
        const trimmedSearch = search.trim(); // Trim spaces
        if (trimmedSearch) {
            navigate(`/category/${encodeURIComponent(trimmedSearch)}`);
            setSearch('');
        }
    };
    ...
    return (
        <div className='navbar'>
            ...
            <div className='navbar__links'>
                ...
                <p className={active === 'Art & Culture' ? 'active' : ''} 
                   onClick={() => { setActive("Art & Culture"); navigate("/category/art-culture") }}> 
                   Art & Culture
                </p>
            </div>
            <div className="navbar__search">
                <input 
                    ...
                    value={search} 
                    onKeyDown={(e) => e.key === 'Enter' && handleSearch()} // Allow "Enter" key for search
                />
