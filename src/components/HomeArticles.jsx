    ...
    <div className="home-articles-container">
      <div className="home-articles-body">
        ...
        {businessNews.length > 0 ? (
          <div className="home-articles">
            {businessNews.slice(0, 3).map((news, index) => (
              <div
                key={news.url || index}
      ...
      <div className="home-articles-body">
        ...
        {technologyNews.length > 0 ? (
          <div className="home-articles">
            {technologyNews.slice(0, 3).map((news, index) => (
              <div
                key={news.url || index}
                className="home-article"
                onClick={() => window.open(news.url, "_blank")}
      ...
      <div className="home-articles-body">
        ...
        {politicsNews.length > 0 ? (
          <div className="home-articles">
            {politicsNews.slice(0, 3).map((news, index) => (
              <div
                key={news.url || index} // ✅ Fix: Added missing key prop
                className="home-article"
                onClick={() => window.open(news.url, "_blank")}
              >
                <img src={news.urlToImage} alt="placeholder" />
